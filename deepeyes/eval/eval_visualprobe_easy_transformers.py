...
def process_work_items(work_items, model_base, device, checkpoint_dir):
    ...
    for idx, item in enumerate(pbar):
        ...
        prompt = instruction_prompt_init.format(question=question)
        ...
        item_res = {'prompt': prompt, 'gt': item["answer"], 'pred': answers, 'acc': accs}
...
if __name__=='__main__':
    ...
    root = 'Evaluation/VisualProbe_Easy'
    path = os.path.join(root, 'VisualProbe_Easy' + '.tsv')
